...
#HERE sector = "Communication Services" -- spez. Sektor
#HERE industry = "Media" -- spez. Branche
#HERE payouts = 12 -- Wer zahlt monatlich?

-- Kombination durch AND
#HERE sector = "Communication Services" AND industry = "Entertainment"
#HERE sector = "Communication Services" AND payouts = 12
-- Kombination durch AND / OR
#HERE sector = "Communication Services" AND (industry = "Entertainment" OR industry = "Media")
-- Kombination durch AND / NOT
WHERE sector = "Communication Services" AND NOT (industry = "Media" OR industry = "Entertainment")
